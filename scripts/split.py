...
def render_graph_Split():
    ...
    g.create_pass('SplitScreenPass', 'SplitScreenPass', {'splitLocation': 0.0, 'showTextLabels': True, 'leftLabel': 'PathTracer', 'rightLabel': 'ReSTIRDI'})
    ...
    g.add_edge('ReSTIRDI.color', 'AccumulatePass0.input')
...
Split = render_graph_Split()
try: m.addGraph(Split)
